...
<body>
	<div class="vladmaxi-top">
        <a href="http://localhost:8080/HappyNovember" target="_blank">Home</a>
            </a>
        </span>
    <div class="clr"></div>
    </div>
...
<form name="login-form" class="login-form" action="http://localhost:8080/HappyNovember/registration" method="post">
    ...
    <div class="content">
		...
		<input name="password confirm" type="password" class="input password" value="password" onfocus="this.value=&#39;&#39;">
    </div>
